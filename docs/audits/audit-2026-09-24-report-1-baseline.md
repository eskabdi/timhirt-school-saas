# Timhirt Audit, Report 1: Baseline Security, Architecture & Compliance Audit

> **Report 1 of 3: Baseline audit (before the INSA document was supplied).**
> This is a frozen snapshot of the audit as first delivered (commit `8c8ffc2`). It uses OWASP WSTG / ASVS L2 as a stand-in for INSA and contains 32 findings.
> The INSA-specific assessment is **Report 2** (`audit-2026-09-24-report-2-insa.md`). The merged, current view is **Report 3** (`audit-2026-09-24-report-3-consolidated.md`). Where they differ, Report 3 supersedes this one.
