...
| `cleanup_old_audit_logs()` | Internal (service_role) | — | 0 | 0 | — | — | `search_path=public, pg_temp` |
...
| `settle_gateway_payment(text,payment_provider,numeric)` | Internal (service_role) | — | 0 | 0 | — | — | `search_path=public, pg_temp` |
