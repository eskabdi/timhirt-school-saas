...
insert into definer_allowlist values
  ...
  ('attendance_retroactive_edit_window_days(uuid)', 'authenticated', 'attendance_retroactive_edit_gate policy; a non-sensitive tenant setting'),
  ...
  ('auto_assign_exam_seats(uuid,integer,integer)', 'authenticated', 'Exams page; own tenant, school_admin or the class teacher'),
