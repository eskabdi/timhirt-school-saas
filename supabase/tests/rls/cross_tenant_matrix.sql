...
insert into public.invoice_headers (id, tenant_id, student_id, due_date) values
  ('aaaa7777-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaa3333-0000-0000-0000-000000000001', '2026-08-01'),
  ('bbbb7777-0000-0000-0000-000000000002', 'bbbbbbbb-0000-0000-0000-000000000002', 'bbbb3333-0000-0000-0000-000000000002', '2026-08-01');

insert into public.fee_invoices (id, tenant_id, student_id, fee_structure_id, amount_due, due_date, invoice_header_id) values
  ('aaaa6666-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaa3333-0000-0000-0000-000000000001', 'aaaa5555-0000-0000-0000-000000000001', 1000, '2026-08-01', 'aaaa7777-0000-0000-0000-000000000001'),
  ('bbbb6666-0000-0000-0000-000000000002', 'bbbbbbbb-0000-0000-0000-000000000002', 'bbbb3333-0000-0000-0000-000000000002', 'bbbb5555-0000-0000-0000-000000000002', 1000, '2026-08-01', 'bbbb7777-0000-0000-0000-000000000002');
