  ...
  return {
    ...
    teachers: {
      headers: [
        ...
        `${t("staffReg.dateOfJoining")} (EC, YYYY-MM-DD)`,
      ...
      example: [
        ...
        "female", "1982-07-14", "Ethiopian", "ID-0123456",
        ...
        "bachelor", "2004", "Mathematics", "Addis Ababa University",
        "amharic;english", "TEFL Certificate 2015", "MATH;PHYS",
        "teacher", "Mathematics Department", "2011-01-01",
