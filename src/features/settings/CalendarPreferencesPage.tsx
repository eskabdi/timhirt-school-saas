...
import {
  DEFAULT_CALENDAR_PREFS, parseCalendarPrefs, serializeCalendarPrefs, useTenantSettings, type CalendarPrefs,
...
// normalised server-side by the tenant_configs trigger (20260925000002).
export function CalendarPreferencesPage() {
  ...
  const save = useMutation({
    mutationFn: async () => {
      ...
      const next = { ...(settings ?? {}), calendar: serializeCalendarPrefs(prefs) };
